...
<div class="container py-4 py-lg-5">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 g-4">
        ...
        <div class="col d-flex">
            {{-- Переиспользуем нашу стандартную карточку товара --}}
    ...
    @else
    <div class="text-center py-5 my-5" style="background-color: var(--bs-tertiary-bg); border-radius: .75rem; border: 1px dashed var(--bs-border-color);">
        <i class="bi bi-heart" style="font-size: 4rem; color: var(--bs-secondary-color);"></i>
